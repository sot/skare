...
# c.TerminalIPythonApp.ipython_dir = u'/home/aldcroft/.config/ipython'
...
# c.TerminalInteractiveShell.editor = '/usr/local/bin/emacs -font "-*-fixed-bold-r-*-*-*-140-*-*-*-*-iso8859-*"'

# Deprecated, use PromptManager.justify
# c.TerminalInteractiveShell.prompts_pad_left = True

# The part of the banner to be printed before the profile
# c.TerminalInteractiveShell.banner1 = 'Python 2.7.1 (r271:86832, Feb  7 2011, 11:30:54) \nType "copyright", "credits" or "license" for more information.\n\nIPython 0.12 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
